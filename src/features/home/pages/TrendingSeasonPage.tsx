...
import { getSeasonLabel } from '../components/TrendingSeason';

export function TrendingSeasonPage() {
  ...
  const loadPage = useCallback(async (page: number) => {
    const data = await fetchSeasonalTrendingAnime(page, 10);
  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        console.error('Error loading seasonal trending page:', e);
      } finally {
        setLoading(false);
      }
    })();
  ...
  const handleLoadMore = async () => {
    ...
    try {
      ...
      console.error('Error loading more seasonal trending:', e);
    } finally {
    ...
    <View style={styles.container}>
      <View style={[
        ...
        <View style={styles.headerRow}>
          ...
          <View>
            <Text style={styles.headerTitle}>Tendencias de temporada {getSeasonLabel()}</Text>
            <Text style={styles.headerSubtitle}>Animes populares de la temporada</Text>
          </View>
        </View>
      </View>
